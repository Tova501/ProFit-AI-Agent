    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            },
            {
                ...
                The response should be in JSON format with the following structure, the arrays can be empty if not applicable, the answer must include recommendation
                (return only this structure without the word "JSON" or any other text):
                {{
                    "score": x,
                    "adventages": ["...", "..."],
                    "disadvantages": ["...", "..."],
